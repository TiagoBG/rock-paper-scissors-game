...
export default function InstructionsCard() {
  return (
    <div className="instructions-card">
        ...
        <div className="back">
          <h2 style={{marginTop: '-0.2rem'}}>Instructions</h2>
          <ol style={{textAlign: 'left'}}>
            ...
            <h4>
              <li>If you win you get +1 points on your score. If you lose you get -1 lives.</li>
            </h4>
            <h4>
            <li>In the case of a tie, you will not get any points or lose any life.</li>
            </h4>
            <h4>
